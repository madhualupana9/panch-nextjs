  ...
  return (
    <div className="body_wrap">
      ...
      <Script id="elementor-frontend-config-before" strategy="beforeInteractive">
        {`
          window.awsmJobsPublic = {"ajaxurl":"","is_admin":""};
          window.pysOptions = {"staticEvents":[],"dynamicEvents":[],"triggerEvent":[],"triggerDynamicEvent":[],"triggerDynamicEvents":[],"google_analytics":{"enabled":false},"facebook":{"enabled":false},"pixel_your_site":{"enabled":false}};
